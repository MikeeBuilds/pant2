/**
 * @component Tvl
 * @description A component that displays TVL information for a cryptocurrency project.
 * @filesource /Users/algohussle/Documents/builds/pant2/components/Tvl.tsx
 * @typedef {import("next").NextPage} NextPage
 */
        ...
        <div className="absolute top-[0px] left-[150px] w-[1726px] h-[1349.27px] overflow-hidden">
          <div className="absolute top-[0px] left-[0px] w-[743px] h-[927.21px] overflow-hidden">
            <div className="absolute top-[372px] left-[0px] shadow-[3.6673245429992676px_3.6673245429992676px_75px_#000] w-[743px] h-[555.21px]">
              ...
              <div className="absolute top-[0px] left-[0px] inline-block w-[743px] h-[127.74px]">
                <p className="m-0 [background:linear-gradient(89.35deg,_#c5a059,_#deb750_28.65%,_#e6d48a_51.56%,_#f6dd75_76.56%,_#c1a05d)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">
                  $ETH BAcking amount
                </p>
                <p className="m-0 text-[124.69px]">
              ...
              <div className="absolute top-[427.48px] left-[0px] inline-block w-[743px] h-[127.74px]">
                <p className="m-0 [background:linear-gradient(89.35deg,_#c5a059,_#deb750_28.65%,_#e6d48a_51.56%,_#f6dd75_76.56%,_#c1a05d)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">
                  PANTHEON LICQUIDITY Pool Amount:
                </p>
                <p className="m-0 text-[124.69px] leading-[111.85px]">
                  $111,222.333
                </p>
              </div>
            </div>
          </div>
          <div className="absolute top-[0px] left-[1224px] w-[319px] h-[72px] overflow-hidden text-3xl">
            <div className="absolute top-[43px] left-[0px] w-[319px] h-[29px]">
              <div className="absolute top-[8px] left-[94px] text-mini text-left hidden w-[71px] h-[13px]">
                explore
              </div>
              <div className="absolute top-[4px] left-[0px] inline-block w-[78px] h-[21px]">
                Learn
              </div>
              <div className="absolute top-[0px] left-[108px] w-[211px] h-[29px] overflow-hidden text-black">
                <div className="absolute top-[0px] left-[116px] rounded [background:linear-gradient(90deg,_#c5a059,_#deb750_22.92%,_#e6d48a_46.35%,_#f6dd75_75.52%,_#b3914c)] w-[95px] h-[29px]">
                  <div className="absolute top-[4px] left-[9px] inline-block w-[77px] h-[22px]">
                    DAPP
                  </div>
                </div>
                <div className="absolute top-[4px] left-[0px] w-[87px] h-[21px] text-left text-white">
                  <div className="absolute top-[0px] left-[21px] inline-block w-[66px] h-[21px]">
                    docs
                  </div>
                  <img
                    className="absolute top-[2px] left-[0px] w-[17px] h-[17px] overflow-hidden"
                    alt=""
                    src="/menuburgerfreeiconfont-11.svg"
                  />
                </div>
              </div>
            </div>
          </div>
          <div className="absolute top-[0px] left-[899px] w-[827px] h-[1349.27px] overflow-hidden">
          <video
              className="absolute top-[34px] left-[0px] w-[827px] h-[1180.27px] object-cover"
              autoPlay
              loop
            >
              <source src="/Column.mov" type="video/mp4" />
