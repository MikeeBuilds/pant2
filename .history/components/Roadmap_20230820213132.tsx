...
const Roadmap: NextPage = () => {
  ...
  textShadow: '0px 0px 75px #000', 
  mixBlendMode: 'normal',
  fontSize: '48px' // Adjust the font size here
}}>
  Roadmap
</h1>
        ...
        <div className="relative w-full md:w-[45%] h-[0%] rounded-[30px] bg-gradient-to-r from-transparent via-gray-100 to-transparent backdrop-blur-md shadow-lg p-4">
