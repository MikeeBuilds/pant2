...
const Footer: React.FC = () => {
  return (
    <div className="w-full h-[50px] font-commodus text-white flex justify-between items-center px-10 lg:px-20 rounded-[30px] bg-gradient-to-r from-transparent via-gray-100 to-transparent backdrop-blur-md shadow-lg">
