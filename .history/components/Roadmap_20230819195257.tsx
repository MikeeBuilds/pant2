  ...
  return (
    <div className="relative w-full h-[1117px] overflow-hidden bg-[url('/road-map@3x.png')] bg-cover bg-no-repeat bg-[top] text-left text-lgi text-white font-commodus">
      ...
      <div className="absolute top-[33px] left-[1374px] w-[319px] h-[29px] text-3xl">
        ...
        <div className="absolute top-[4px] left-[0px] text-center inline-block w-[78px] h-[21px]">
          Learn
        </div>
        <div className="absolute top-[4px] left-[108px] w-[87px] h-[21px] flex flex-row items-center justify-start gap-[4px]">
          <img
            className="relative w-[17px] h-[17px] overflow-hidden shrink-0"
            alt=""
            src="/menuburgerfreeiconfont-12.svg"
          />
          <div className="relative inline-block w-[66px] h-[21px] shrink-0">
            docs
          </div>
        </div>
