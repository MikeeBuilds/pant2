...
const Footer: React.FC = () => {
  return (
    <div className="w-full h-[50px] font-commodus bg-transparent text-white flex justify-between items-center px-10 lg:px-20 backdrop-blur-md bg-opacity-40 border border-gray-200 rounded">
