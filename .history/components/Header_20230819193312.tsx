    ...
    <div className="absolute top-0 left-0 w-full">
      <div className="flex items-center justify-between w-full max-w-7xl mx-auto py-5 px-4 lg:px-0">
        ...
        <div className="lg:hidden flex flex-1 justify-end items-center pr-4">
          ...
          />
          <div className={`${!toggle ? 'hidden' : 'flex'} p-6 bg-[rgba(0,0,0,0.4)] backdrop-blur-md absolute top-20 right-4 mx-4 my-2 min-w-[140px] z-10 rounded-xl`}>
            <div className="border-t border-b border-white flex flex-col justify-center items-center gap-4 text-white text-3xl font-commodus">
