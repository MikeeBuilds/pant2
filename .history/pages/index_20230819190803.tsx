...
const Home: NextPage = () => {
  return (
    <div className="relative w-full h-[1117px] md:h-screen overflow-hidden text-white font-commodus">
      ...
      />
      <div className="absolute top-[985px] md:top-[80%] left-[calc(50%_-_348px)] leading-[0%] font-extralight font-metropolis text-center inline-block w-[696px] h-[31px] md:text-lg">
